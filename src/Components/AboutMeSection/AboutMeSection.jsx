    ...
    return (
        <section className="about-me-section ">
            ...
            <div className="about-me-container grid grid-cols-1 md:grid-cols-2 gap-4 ">
                ...
                <div className="about-me-container text-left ">
                ...
                <div className="about-me-cell2 about-me-profile grid [grid-template-columns:3fr_1fr]   justify-items-end">
                    <img
                        className="profile-img w-63 h-auto rounded-lg grayscale hover:grayscale-0 hover:scale-105 transition duration-700 ease-in-out"
