export default function GreetingsCodeComponent() {
    return (
        <div
            className="introduction-greeting order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] text-left overflow-auto">
